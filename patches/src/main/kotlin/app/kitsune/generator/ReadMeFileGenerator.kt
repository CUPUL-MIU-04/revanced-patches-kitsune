...
internal class ReadMeFileGenerator : PatchesFileGenerator {
    ...
    // Supported version of [app.kitsune.patches.music.utils.integrations.Constants.COMPATIBLE_PACKAGE] should be empty.
    ...
    override fun generate(patches: Set<Patch<*>>) {
        ...
        mapOf(
            app.kitsune.patches.music.utils.compatibility.Constants.COMPATIBLE_PACKAGE to "\"COMPATIBLE_PACKAGE_MUSIC\"",
            app.kitsune.patches.reddit.utils.compatibility.Constants.COMPATIBLE_PACKAGE to "\"COMPATIBLE_PACKAGE_REDDIT\"",
            app.kitsune.patches.youtube.utils.compatibility.Constants.COMPATIBLE_PACKAGE to "\"COMPATIBLE_PACKAGE_YOUTUBE\""
