...
import app.kitsune.patcher.util.proxy.mutableTypes.encodedValue.MutableLongEncodedValue
import app.kitsune.patches.shared.extension.Constants.EXTENSION_UTILS_CLASS_DESCRIPTOR
import app.kitsune.patches.shared.extension.Constants.EXTENSION_UTILS_PATH
import app.kitsune.patches.shared.mainactivity.injectConstructorMethodCall
...
import app.kitsune.patches.youtube.utils.fix.attributes.themeAttributesPatch
import app.kitsune.patches.youtube.utils.fix.cairo.cairoFragmentPatch
import app.kitsune.patches.youtube.utils.fix.playbackspeed.playbackSpeedWhilePlayingPatch
import app.kitsune.patches.youtube.utils.fix.splash.darkModeSplashScreenPatch
import app.kitsune.patches.youtube.utils.mainactivity.mainActivityResolvePatch
import app.kitsune.patches.youtube.utils.patch.PatchList.SETTINGS_FOR_YOUTUBE
...
private const val DEFAULT_LABEL = "KITSUNE RVX"
...
val settingsPatch = resourcePatch(
    ...
    val rvxSettingsLabel = stringOption(
        ...
        values = mapOf(
            ...
            "RVX" to "RVX",
            "RVX PLUS" to "RVX PLUS",
            "YT RVX" to "YT RVX",
            "YT PLUS" to "YT PLUS",
            "KITSUNE PLUS" to "KITSUNE PLUS",
            "KITSUNE RVX" to DEFAULT_LABEL,
        ),
