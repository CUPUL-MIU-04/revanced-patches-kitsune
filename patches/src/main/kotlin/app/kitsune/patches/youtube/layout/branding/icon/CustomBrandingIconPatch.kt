package app.kitsune.patches.youtube.layout.branding.icon
...
import app.kitsune.patches.youtube.utils.patch.PatchList.CUSTOM_BRANDING_ICON_FOR_YOUTUBE
import app.kitsune.patches.youtube.utils.playservice.is_19_17_or_greater
import app.kitsune.patches.youtube.utils.playservice.is_19_32_or_greater
...
import app.kitsune.patches.youtube.utils.settings.ResourceUtils.updatePatchStatusIcon
import app.kitsune.patches.youtube.utils.settings.getBytecodeContext
...
import app.kitsune.util.copyAdaptiveIcon
import app.kitsune.util.copyFile
import app.kitsune.util.copyResources
import app.kitsune.util.getResourceGroup
import app.kitsune.util.underBarOrThrow
