package app.kitsune.patches.youtube.player.seekbar
...
import app.kitsune.patches.shared.drawable.addDrawableColorHook
import app.kitsune.patches.shared.drawable.drawableColorHookPatch
...
import app.kitsune.patches.youtube.utils.patch.PatchList.SEEKBAR_COMPONENTS
import app.kitsune.patches.youtube.utils.playerButtonsResourcesFingerprint
import app.kitsune.patches.youtube.utils.playerButtonsVisibilityFingerprint
import app.kitsune.patches.youtube.utils.playerSeekbarColorFingerprint
...
import app.kitsune.patches.youtube.utils.playservice.is_19_49_or_greater
import app.kitsune.patches.youtube.utils.playservice.versionCheckPatch
import app.kitsune.patches.youtube.utils.resourceid.inlineTimeBarColorizedBarPlayedColorDark
import app.kitsune.patches.youtube.utils.resourceid.inlineTimeBarPlayedNotHighlightedColor
import app.kitsune.patches.youtube.utils.resourceid.reelTimeBarPlayedColor
import app.kitsune.patches.youtube.utils.resourceid.sharedResourceIdPatch
import app.kitsune.patches.youtube.utils.resourceid.ytStaticBrandRed
import app.kitsune.patches.youtube.utils.seekbarFingerprint
import app.kitsune.patches.youtube.utils.seekbarOnDrawFingerprint
...
import app.kitsune.patches.youtube.utils.settings.ResourceUtils.restoreOldSplashAnimationIncluded
import app.kitsune.patches.youtube.utils.settings.settingsPatch
import app.kitsune.patches.youtube.utils.totalTimeFingerprint
...
import app.kitsune.util.findElementByAttributeValueOrThrow
import app.kitsune.util.findMethodsOrThrow
...
import app.kitsune.util.inputStreamFromBundledResource
        ...
        context.document("res/drawable/resume_playback_progressbar_drawable.xml")
            .use { document ->
                ...
                val replacementNode = document.createElement(
                    "app.kitsune.extension.youtube.patches.utils.ProgressBarDrawable"
                )
