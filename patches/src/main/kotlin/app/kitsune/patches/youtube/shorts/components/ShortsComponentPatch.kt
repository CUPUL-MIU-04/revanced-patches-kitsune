package app.kitsune.patches.youtube.shorts.components
...
import app.kitsune.patcher.extensions.InstructionExtensions.removeInstructions
...
import app.kitsune.patches.shared.mainactivity.injectOnCreateMethodCall
...
import app.kitsune.patches.youtube.utils.bottomSheetMenuItemBuilderFingerprint
...
import app.kitsune.patches.youtube.utils.extension.Constants.SHORTS_CLASS_DESCRIPTOR
import app.kitsune.patches.youtube.utils.extension.Constants.SHORTS_PATH
import app.kitsune.patches.youtube.utils.extension.Constants.UTILS_PATH
import app.kitsune.patches.youtube.utils.indexOfSpannedCharSequenceInstruction
import app.kitsune.patches.youtube.utils.lottie.LOTTIE_ANIMATION_VIEW_CLASS_DESCRIPTOR
import app.kitsune.patches.youtube.utils.lottie.lottieAnimationViewHookPatch
...
import app.kitsune.patches.youtube.utils.patch.PatchList.HIDE_FEED_FLYOUT_MENU
import app.kitsune.patches.youtube.utils.patch.PatchList.SHORTS_COMPONENTS
import app.kitsune.patches.youtube.utils.playertype.playerTypeHookPatch
import app.kitsune.patches.youtube.utils.playservice.is_18_31_or_greater
import app.kitsune.patches.youtube.utils.playservice.is_18_34_or_greater
import app.kitsune.patches.youtube.utils.playservice.is_18_49_or_greater
import app.kitsune.patches.youtube.utils.playservice.is_19_02_or_greater
import app.kitsune.patches.youtube.utils.playservice.is_19_11_or_greater
...
import app.kitsune.patches.youtube.utils.playservice.is_20_09_or_greater
...
import app.kitsune.patches.youtube.utils.resourceid.bottomBarContainer
import app.kitsune.patches.youtube.utils.resourceid.metaPanel
import app.kitsune.patches.youtube.utils.resourceid.reelDynRemix
import app.kitsune.patches.youtube.utils.resourceid.reelDynShare
import app.kitsune.patches.youtube.utils.resourceid.reelFeedbackLike
import app.kitsune.patches.youtube.utils.resourceid.reelFeedbackPause
import app.kitsune.patches.youtube.utils.resourceid.reelFeedbackPlay
import app.kitsune.patches.youtube.utils.resourceid.reelForcedMuteButton
import app.kitsune.patches.youtube.utils.resourceid.reelPlayerFooter
import app.kitsune.patches.youtube.utils.resourceid.reelPlayerRightPivotV2Size
import app.kitsune.patches.youtube.utils.resourceid.reelRightDislikeIcon
import app.kitsune.patches.youtube.utils.resourceid.reelRightLikeIcon
import app.kitsune.patches.youtube.utils.resourceid.reelVodTimeStampsContainer
import app.kitsune.patches.youtube.utils.resourceid.rightComment
...
import app.kitsune.patches.youtube.utils.toolbar.hookToolBar
import app.kitsune.patches.youtube.utils.toolbar.toolBarHookPatch
import app.kitsune.patches.youtube.utils.videoIdFingerprintShorts
import app.kitsune.patches.youtube.video.information.hookShortsVideoInformation
import app.kitsune.patches.youtube.video.information.videoInformationPatch
import app.kitsune.patches.youtube.video.playbackstart.PLAYBACK_START_DESCRIPTOR_CLASS_DESCRIPTOR
import app.kitsune.patches.youtube.video.playbackstart.playbackStartDescriptorPatch
import app.kitsune.patches.youtube.video.playbackstart.playbackStartVideoIdReference
import app.kitsune.patches.youtube.video.playbackstart.shortsPlaybackStartIntentFingerprint
import app.kitsune.patches.youtube.video.playbackstart.shortsPlaybackStartIntentLegacyFingerprint
...
import app.kitsune.util.cloneMutable
...
import app.kitsune.util.indexOfFirstLiteralInstruction
import app.kitsune.util.indexOfFirstLiteralInstructionOrThrow
import app.kitsune.util.indexOfFirstStringInstruction
import app.kitsune.util.indexOfFirstStringInstructionOrThrow
import app.kitsune.util.injectLiteralInstructionViewCall
