package app.kitsune.patches.music.player.components
...
import app.kitsune.patcher.patch.ResourcePatchContext
import app.kitsune.patcher.patch.bytecodePatch
import app.kitsune.patcher.patch.resourcePatch
import app.kitsune.patcher.util.proxy.mutableTypes.MutableField.Companion.toMutable
...
import app.kitsune.patches.music.utils.extension.Constants.PLAYER_CLASS_DESCRIPTOR
import app.kitsune.patches.music.utils.mainactivity.mainActivityResolvePatch
import app.kitsune.patches.music.utils.patch.PatchList.PLAYER_COMPONENTS
...
import app.kitsune.patches.music.utils.playservice.is_7_18_or_greater
import app.kitsune.patches.music.utils.playservice.is_7_25_or_greater
import app.kitsune.patches.music.utils.playservice.is_7_29_or_greater
import app.kitsune.patches.music.utils.playservice.is_8_03_or_greater
...
import app.kitsune.patches.music.utils.resourceid.darkBackground
import app.kitsune.patches.music.utils.resourceid.miniPlayerPlayPauseReplayButton
import app.kitsune.patches.music.utils.resourceid.miniPlayerViewPager
import app.kitsune.patches.music.utils.resourceid.playerViewPager
import app.kitsune.patches.music.utils.resourceid.sharedResourceIdPatch
import app.kitsune.patches.music.utils.resourceid.tapBloomView
import app.kitsune.patches.music.utils.resourceid.topEnd
import app.kitsune.patches.music.utils.resourceid.topStart
...
import app.kitsune.patches.music.utils.videotype.videoTypeHookPatch
...
import app.kitsune.util.adoptChild
import app.kitsune.util.cloneMutable
import app.kitsune.util.doRecursively
import app.kitsune.util.findInstructionIndicesReversed
...
import app.kitsune.util.fingerprint.matchOrNull
import app.kitsune.util.fingerprint.matchOrThrow
import app.kitsune.util.fingerprint.methodCall
...
import app.kitsune.util.insertNode
