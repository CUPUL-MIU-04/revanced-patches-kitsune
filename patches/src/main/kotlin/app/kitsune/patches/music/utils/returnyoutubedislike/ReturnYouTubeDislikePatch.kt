...
import app.kitsune.patches.music.utils.ACTION_BAR_POSITION_FEATURE_FLAG
import app.kitsune.patches.music.utils.actionBarPositionFeatureFlagFingerprint
...
import app.kitsune.patches.music.utils.patch.PatchList.RETURN_YOUTUBE_DISLIKE
import app.kitsune.patches.music.utils.playservice.is_7_17_or_greater
...
import app.kitsune.patches.music.utils.settings.ResourceUtils.PREFERENCE_CATEGORY_TAG_NAME
import app.kitsune.patches.music.utils.settings.ResourceUtils.SETTINGS_HEADER_PATH
import app.kitsune.patches.music.utils.settings.ResourceUtils.addPreferenceCategoryUnderPreferenceScreen
...
import app.kitsune.patches.shared.dislikeFingerprint
import app.kitsune.patches.shared.likeFingerprint
import app.kitsune.patches.shared.removeLikeFingerprint
