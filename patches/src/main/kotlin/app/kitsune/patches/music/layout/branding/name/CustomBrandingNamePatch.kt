package app.kitsune.patches.music.layout.branding.name
...
import app.kitsune.patches.music.utils.patch.PatchList.CUSTOM_BRANDING_NAME_FOR_YOUTUBE_MUSIC
...
val customBrandingNamePatch = resourcePatch(
    ...
    val appNameNotificationOption = stringOption(
        ...
        values = mapOf(
            ...
            "YouTube Music RVX" to "YouTube Music RVX",
