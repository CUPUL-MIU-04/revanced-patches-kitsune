package app.kitsune.extension.music.settings.preference;

import static app.kitsune.extension.music.settings.Settings.BYPASS_IMAGE_REGION_RESTRICTIONS_DOMAIN;
import static app.kitsune.extension.music.settings.Settings.CHANGE_START_PAGE;
import static app.kitsune.extension.music.settings.Settings.CUSTOM_FILTER_STRINGS;
import static app.kitsune.extension.music.settings.Settings.CUSTOM_PLAYBACK_SPEEDS;
import static app.kitsune.extension.music.settings.Settings.CUSTOM_PLAYER_BACKGROUND_COLOR_PRIMARY;
import static app.kitsune.extension.music.settings.Settings.CUSTOM_PLAYER_BACKGROUND_COLOR_SECONDARY;
import static app.kitsune.extension.music.settings.Settings.DISABLE_MUSIC_VIDEO_IN_ALBUM_REDIRECT_TYPE;
import static app.kitsune.extension.music.settings.Settings.ENABLE_CUSTOM_NAVIGATION_BAR_COLOR_VALUE;
import static app.kitsune.extension.music.settings.Settings.EXTERNAL_DOWNLOADER_PACKAGE_NAME;
import static app.kitsune.extension.music.settings.Settings.HIDE_ACCOUNT_MENU_FILTER_STRINGS;
import static app.kitsune.extension.music.settings.Settings.OPEN_DEFAULT_APP_SETTINGS;
import static app.kitsune.extension.music.settings.Settings.OPTIONAL_SPONSOR_BLOCK_SETTINGS_PREFIX;
import static app.kitsune.extension.music.settings.Settings.REPLACE_NAVIGATION_BUTTON_ABOUT;
import static app.kitsune.extension.music.settings.Settings.RETURN_YOUTUBE_USERNAME_ABOUT;
import static app.kitsune.extension.music.settings.Settings.SB_API_URL;
import static app.kitsune.extension.music.settings.Settings.SETTINGS_IMPORT_EXPORT;
import static app.kitsune.extension.music.settings.Settings.SPOOF_APP_VERSION_TARGET;
import static app.kitsune.extension.music.settings.Settings.SPOOF_CLIENT_TYPE;
import static app.kitsune.extension.music.settings.Settings.WATCH_HISTORY_TYPE;
import static app.kitsune.extension.music.utils.ExtendedUtils.getDialogBuilder;
import static app.kitsune.extension.music.utils.ExtendedUtils.getLayoutParams;
import static app.kitsune.extension.music.utils.RestartUtils.showRestartDialog;
import static app.kitsune.extension.shared.settings.BaseSettings.RETURN_YOUTUBE_USERNAME_DISPLAY_FORMAT;
import static app.kitsune.extension.shared.settings.BaseSettings.RETURN_YOUTUBE_USERNAME_YOUTUBE_DATA_API_V3_DEVELOPER_KEY;
import static app.kitsune.extension.shared.settings.Setting.getSettingFromPath;
import static app.kitsune.extension.shared.utils.ResourceUtils.getStringArray;
import static app.kitsune.extension.shared.utils.StringRef.str;
import static app.kitsune.extension.shared.utils.Utils.isSDKAbove;
...
import app.kitsune.extension.music.patches.utils.ReturnYouTubeDislikePatch;
import app.kitsune.extension.music.returnyoutubedislike.ReturnYouTubeDislike;
import app.kitsune.extension.music.settings.ActivityHook;
import app.kitsune.extension.music.settings.Settings;
import app.kitsune.extension.music.utils.ExtendedUtils;
import app.kitsune.extension.shared.settings.BooleanSetting;
import app.kitsune.extension.shared.settings.EnumSetting;
import app.kitsune.extension.shared.settings.Setting;
import app.kitsune.extension.shared.settings.StringSetting;
import app.kitsune.extension.shared.settings.preference.YouTubeDataAPIDialogBuilder;
