package app.kitsune.extension.youtube.sponsorblock.objects;

import static app.kitsune.extension.shared.utils.StringRef.sf;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_FILLER;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_FILLER_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_FILLER_OPACITY;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_HIGHLIGHT;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_HIGHLIGHT_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_HIGHLIGHT_OPACITY;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_INTERACTION;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_INTERACTION_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_INTERACTION_OPACITY;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_INTRO;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_INTRO_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_INTRO_OPACITY;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC_OPACITY;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_OUTRO;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_OUTRO_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_OUTRO_OPACITY;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_PREVIEW;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_PREVIEW_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_PREVIEW_OPACITY;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_SELF_PROMO;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_SELF_PROMO_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_SELF_PROMO_OPACITY;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_SPONSOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_SPONSOR_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_SPONSOR_OPACITY;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_UNSUBMITTED;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_UNSUBMITTED_COLOR;
import static app.kitsune.extension.youtube.settings.Settings.SB_CATEGORY_UNSUBMITTED_OPACITY;
...
import app.kitsune.extension.shared.settings.FloatSetting;
import app.kitsune.extension.shared.settings.StringSetting;
import app.kitsune.extension.shared.utils.Logger;
import app.kitsune.extension.shared.utils.StringRef;
