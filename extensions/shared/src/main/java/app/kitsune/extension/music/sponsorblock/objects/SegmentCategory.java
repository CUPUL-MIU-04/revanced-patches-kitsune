package app.kitsune.extension.music.sponsorblock.objects;

import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_FILLER;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_FILLER_COLOR;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_INTERACTION;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_INTERACTION_COLOR;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_INTRO;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_INTRO_COLOR;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC_COLOR;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_OUTRO;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_OUTRO_COLOR;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_PREVIEW;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_PREVIEW_COLOR;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_SELF_PROMO;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_SELF_PROMO_COLOR;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_SPONSOR;
import static app.kitsune.extension.music.settings.Settings.SB_CATEGORY_SPONSOR_COLOR;
