package app.kitsune.extension.youtube.settings;

import static java.lang.Boolean.FALSE;
import static java.lang.Boolean.TRUE;
import static app.kitsune.extension.shared.settings.Setting.migrateFromOldPreferences;
import static app.kitsune.extension.shared.settings.Setting.parent;
import static app.kitsune.extension.shared.settings.Setting.parentsAny;
import static app.kitsune.extension.shared.utils.StringRef.str;
import static app.kitsune.extension.youtube.patches.player.MiniplayerPatch.MiniplayerType;
import static app.kitsune.extension.youtube.patches.player.MiniplayerPatch.MiniplayerType.MODERN_1;
import static app.kitsune.extension.youtube.patches.player.MiniplayerPatch.MiniplayerType.MODERN_2;
import static app.kitsune.extension.youtube.patches.player.MiniplayerPatch.MiniplayerType.MODERN_3;
import static app.kitsune.extension.youtube.patches.player.MiniplayerPatch.MiniplayerType.MODERN_4;
import static app.kitsune.extension.youtube.sponsorblock.objects.CategoryBehaviour.MANUAL_SKIP;
import static app.kitsune.extension.youtube.sponsorblock.objects.CategoryBehaviour.SKIP_AUTOMATICALLY;
import static app.kitsune.extension.youtube.sponsorblock.objects.CategoryBehaviour.SKIP_AUTOMATICALLY_ONCE;
...
import app.kitsune.extension.shared.settings.IntegerSetting;
import app.kitsune.extension.shared.settings.LongSetting;
import app.kitsune.extension.shared.settings.Setting;
import app.kitsune.extension.shared.settings.StringSetting;
import app.kitsune.extension.shared.settings.preference.SharedPrefCategory;
import app.kitsune.extension.shared.utils.Logger;
import app.kitsune.extension.shared.utils.Utils;
import app.kitsune.extension.youtube.patches.alternativethumbnails.AlternativeThumbnailsPatch.DeArrowAvailability;
import app.kitsune.extension.youtube.patches.alternativethumbnails.AlternativeThumbnailsPatch.StillImagesAvailability;
import app.kitsune.extension.youtube.patches.alternativethumbnails.AlternativeThumbnailsPatch.ThumbnailOption;
import app.kitsune.extension.youtube.patches.alternativethumbnails.AlternativeThumbnailsPatch.ThumbnailStillTime;
import app.kitsune.extension.youtube.patches.general.ChangeFormFactorPatch.FormFactor;
import app.kitsune.extension.youtube.patches.general.ChangeStartPagePatch;
import app.kitsune.extension.youtube.patches.general.ChangeStartPagePatch.StartPage;
import app.kitsune.extension.youtube.patches.general.YouTubeMusicActionsPatch;
import app.kitsune.extension.youtube.patches.player.ExitFullscreenPatch.FullscreenMode;
import app.kitsune.extension.youtube.patches.player.MiniplayerPatch;
import app.kitsune.extension.youtube.patches.shorts.AnimationFeedbackPatch.AnimationType;
import app.kitsune.extension.youtube.patches.shorts.ShortsRepeatStatePatch.ShortsLoopBehavior;
import app.kitsune.extension.youtube.patches.swipe.SwipeControlsPatch;
import app.kitsune.extension.youtube.patches.utils.PatchStatus;
import app.kitsune.extension.youtube.shared.PlaylistIdPrefix;
import app.kitsune.extension.youtube.sponsorblock.SponsorBlockSettings;
